...
public class PlatformReportIndexBizImp implements
		PlatformReportIndexBiz {
	private PlatformReportIndexDAO platformReportIndexDAO;
	
	public long save(PlatformReportIndex platformReportIndex) throws AppException {
	...
	public long update(PlatformReportIndex platformReportIndex) throws AppException {
	...
	public long deletePlatformReportIndex(long id) throws AppException {
		PlatformReportIndex tempAirline = platformReportIndexDAO.getPlatformReportIndexById(id);
		if (tempAirline == null) {
			return 0;
		} else {
