...
public class PlatformListAction extends BaseAction{
	...
	//显示详细信息
	public ActionForward viewPlatformPage(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws AppException {
			String forwardPage ="";
			try {
				String platformId = request.getParameter("platformId");
				Platform platform = platformBiz.getPlatformByid(Long.parseLong(platformId));
