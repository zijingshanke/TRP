package com.fdays.tsms.right.action;

import java.util.*;
import javax.servlet.http.*;
import org.apache.struts.action.*;

import com.fdays.tsms.right.RoleForm;
import com.fdays.tsms.right.RoleListForm;
import com.fdays.tsms.right.RoleRightForm;
...
public class RoleListAction extends Action
{
	...
	public void doSysList(RoleListForm ulf, HttpServletRequest request)
	{
		...
		sql = "select * from role where role_status=1 and role_system=0 order by role_name ";
	    ...
	    HttpServletRequest request, UserRightInfo uri)
	{
		 ...
		 * inf.setMessage(""); inf.setBack(true);
