...
public class ExcelTest {
	public static void main(String[] args) {
		//===========导出
//		List<AirticketOrder> testOrderList = AirticketGroup.getTestOrderList();//
//		List<AirticketGroup> groupList = AirticketGroup.getGroupList(testOrderList);
//		AirticketGroup.printGroupList(groupList);
//		testExport(groupList);
