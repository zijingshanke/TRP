...
<c:import url="../_jsp/mainTitle.jsp" charEncoding="UTF-8">
	...
	<c:param name="title2" value="对比网电报表" />
</c:import>
		...
		<td valign="top" class="body">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td>
						<html:hidden property="compareType" value="4" name="reportCompare"  />
...
<script type="text/javascript">	
		function startNetworkCompare(){				   
		    document.forms[0].action="<%=path%>/transaction/reportCompare.do?thisAction=compareNetworkReport";
		    document.forms[0].submit();
		}		
		
		function addNetworkReport(){	
			if(checkForm()){   
		    	document.forms[0].action="<%=path%>/transaction/reportCompare.do?thisAction=insertNetworkReport";
		    	document.forms[0].submit();
			}			
		}
		
		function updateNetworkOrderCompareList(){	
			if(checkForm()){		   
		    	document.forms[0].action="<%=path%>/transaction/reportCompare.do?thisAction=updateNetworkOrderCompareList";
		    	document.forms[0].submit();
			}			 
		}		
		
		function clearNetworkCompare(){	   
		    	document.forms[0].action="<%=path%>/transaction/reportCompareList.do?thisAction=clearNetworkCompare";
		    	document.forms[0].submit();
		}				
