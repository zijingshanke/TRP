			...
			<div id="sideBar">
				<div class="sideBarItem webAdmin">
					...
					<ul class="contents" id="ulBusiness">
						...
						<c:check code="sg02">
							<li>
								<a href="../airticket/report.do?thisAction=loadSaleReport"
						...
						<c:check code="sg07">
							<li>
								<a href="../report/teamSaleReport.jsp" target="mainFrame">团队统计报表</a>
							</li>
						</c:check>
						<c:check code="sg08">
							<li>
								<a href="../report/teamRakeOffReport.jsp" target="mainFrame">团队未返代理费报表</a>
							</li>
						</c:check>
					</ul>
					<span class="title"><a href="#"
