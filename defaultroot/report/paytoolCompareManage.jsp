...
/*
	...
	<body>
		<div id="divSearchBarTool">
			<jsp:include page="./paytoolCompareToolBar.jsp"></jsp:include>
		</div>
		<div id="divProblemCompareList1">
			<jsp:include page="./listPaytoolCompareResult1.jsp"></jsp:include>
		</div>
		<div id="divProblemCompareList2">
			<jsp:include page="./listPaytoolCompareResult2.jsp"></jsp:include>
		</div>
	</body>
</html>