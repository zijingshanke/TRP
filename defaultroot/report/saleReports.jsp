...
<html>
	...
	<body>	
		<div id="mainContainer">
			<div id="container">
				<html:form action="/report/listReports.do?thisAction=downLoadsaleReports">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../_jsp/mainTitle.jsp?title1=付款管理&title2=销售报表"
									charEncoding="UTF-8" />
						...
						卖出平台：
						<table  cellpadding="0" cellspacing="0" border="0"	class="dataList">									<tr>
