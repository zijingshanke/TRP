...
<c:param name="title1" value="用户角色" />	
</c:import>
		...
		<tr>
			...
			<table width="100%" style="margin-top: 5px;">
				<tr>
					...
					<td align="right"><a
						href="JavaScript:turnToPage(document.roleListForm,0)">首页</a> <a
						href="JavaScript:turnToPage(document.roleListForm,1)">前页</a> <a
						href="JavaScript:turnToPage(document.roleListForm,2)">后页</a> <a
						href="JavaScript:turnToPage(document.roleListForm,3)">尾页</a> <c:out
