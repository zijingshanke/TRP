...
<div id="mainContainer">
  ...
  <div id="sideBar">
    <div class="sideBarItem webAdmin"> <span class="title"><a href="#">系统管理</a> </span>
      <ul class="contents">
        <li> <a href="loginloglist.do?thisAction=list&locate=2"
								target="mainFrame">登录日志</a> </li>
        <li> <a href="ticketloglist.do?thisAction=list" target="mainFrame">操作日志</a> </li>
      </ul>
    </div>
  </div>
