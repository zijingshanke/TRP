							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<tr>
										...
										<td style="text-align: left">										
											<html:select property="paymentToolId" name="account" styleClass="colorblue2 p_5"
												style="width:200px;" >												
									...
									<tr>
										...
										<td style="text-align: left">										
											<html:text property="name" name="account" value="${account.name}" styleClass="colorblue2 p_5"
									...
									<tr>
										...
										<td style="text-align: left">
											...
											<html:select property="status" name="account" styleClass="colorblue2 p_5"
												style="width:50px;">
