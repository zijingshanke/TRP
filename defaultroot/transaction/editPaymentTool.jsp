							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<tr>
										...
										<td style="text-align: left">										
											<html:text property="name" name="paymentTool" value="${paymentTool.name}" styleClass="colorblue2 p_5"
									...
									<tr>
										...
										<td style="text-align: left">
											...
											<html:select property="type" name="paymentTool" styleClass="colorblue2 p_5"
												style="width:50px;">
									...
									<tr>
										...
										<td style="text-align: left">
											...
											<html:select property="status" name="paymentTool" styleClass="colorblue2 p_5"
												style="width:50px;">
