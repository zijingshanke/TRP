...
<div id="header">
  <div class="logo">
    <img src="_img/tsLogo.png" alt="logo" class="imgLogo"/> 
    <span class="sysTitle">泰申综合业务管理系统</span>
  </div>
  <div class="mainNav">
    <ul class="navContent">
      ...
      <c:check code="sd01-sd03">
        <li> <a href="agent/left.jsp" target="leftFrame">客户管理</a> </li>
      </c:check>
      <c:check code="sf01-sf16">
        <li> <a href="transaction/left.jsp" target="leftFrame">结算管理</a> </li>
      </c:check>
      <c:check code="sg01-sg15">
        <li> <a href="report/left.jsp" target="leftFrame">报表管理</a> </li>
      </c:check>
