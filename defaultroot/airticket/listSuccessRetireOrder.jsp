...
<html>
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="/airticket/listAirTicketOrder.do?thisAction=listSuccessRetireOrder">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../_jsp/mainTitle.jsp?title1=票务管理&title2=完成退款订单"
									charEncoding="UTF-8" />
			              	...
			              	<c:if test="${info.status==22||info.status==32}">
								  <c:check code="sb55">
