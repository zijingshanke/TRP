...
<div id="searchBarObj" class="searchBar">
	<table cellpadding="0" cellspacing="0" border="0" class="searchPanel">
		<tr>
			...
			<td>
				<html:checkbox property="ifRecently" styleId="ifRecentlyObj"
					style="width:30px" value="1" onclick="selectRecent()"/>
				最近
				<html:text property="recentlyDay" styleId="recentlyDayId" value="1"
		...
		<tr>
			...
			<td>
				...
				<a href="#" onclick="shrinkSearchBar()">收起搜索栏</a>
			</td>
		</tr>
	</table>
	</div>
