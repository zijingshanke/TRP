...
<html>
	<head>
		...
		<script type="text/javascript">//返回
			function returnPage()
			{
				document.forms[0].action="<%=path %>/airticket/listAirTicketOrder.do?thisAction=listTeamAirticketOrder";
				document.forms[0].submit();
			}
		</script>
								...
								<table cellpadding="0" cellspacing="0" border="0" id="table1"
									...
									<tr>
										<td>
												...
												<html:hidden property="tranType" value="${airticketOrder.tranType}"/>
	...
	<form id="form1" action="../airticket/airticketOrder.do?thisAction=insertTeamTradingOrder" name="airticketOrder" method="post">
	   <table id="list">
                ...
                <tr>
                    <td>应收票款：</td>
                    <td align="left">
                        <input name="txtSAmount" id="txtSAmount"  class="colorblue2" type="text" readonly="readonly" style="width: 70px;">
                    ...
                    <td>实收票款：</td>
                    <td align="left"> 
                    <input name="txtTotalAmount" id="txtTotalAmount" class="colorblue2 p_5" type="text" readonly="readonly"  style="width: 70px;">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        +机建燃油税&nbsp;&nbsp;&nbsp;<input name="txtTax" id="txtTax" class="colorblue2 p_5" type="text" readonly="readonly" style="width: 70px;" />
                        </td>
                </tr>
                <tr>
                    <td>订单金额：</td>
