...
<html>
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="/airticket/listAirTicketOrder.do?thisAction=listTeamNewRefundAirticketOrde">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../_jsp/mainTitle.jsp?title1=票务管理&title2=待审核退废订单"
									charEncoding="UTF-8" />
                        		...
                        		<c:forEach var="info" items="${ulf.list}" varStatus="status">
									<tr>
                                      ...
                                      <c:forEach var="flight3" items="${info.flights}">
										...
										<td>
											<c:check code="sb77">
											<a href="<%=path %>/airticket/listAirTicketOrder.do?thisAction=updateTeamRefundAirticketOrder&airticketOrderId=<c:out value="${info.id}" />">申请退票</a>
											</c:check>
										</td>
									</tr>
                                 </c:forEach>
