...
<html>
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="airticket/airticketOrder.do?thisAction=saveRufundAirticketOrderTemp" method="post" >					
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../_jsp/mainTitle.jsp?title1=票务管理&title2=团队退废订单录入"
									charEncoding="UTF-8" />
								...
								<div class="searchBar">
									<table cellpadding="0" cellspacing="0" border="0"
										...
										<tr>
											...
											<td>
												<html:hidden property="tranType"  value="3" name="airticketOrder"/>
												成人数
								...
								<div class="searchBar">
									<table cellpadding="0" cellspacing="0" border="0"
										...
										<td>订单金额</td>
										<td>
											<html:hidden property="teamAddPrice" name="airticketOrder" value="0"/>
											<html:hidden property="agentAddPrice" name="airticketOrder" value="0"/>
