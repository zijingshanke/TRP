									...
									<table cellpadding="0" cellspacing="0" border="0"
										...
										<tr>
											...
											<td>
												...
												最近
												<html:text property="userNo" style="width:30px"
													maxlength="3" value="1" />
												天
											</td>
										</tr>
										<tr>
											<td>
												买入
												<html:select property="fromPlatformId"
													styleClass="colorblue2 p_5" style="width:150px;">
													<html:option value="">---请选择---</html:option>
											...
											<td>
												卖出
												<html:select property="toPlatformId"
													styleClass="colorblue2 p_5" style="width:150px;">
													<html:option value="">---请选择---</html:option>
									...
									<c:forEach var="groupInfo" items="${ulf.list}"
										...
										<tr>
											<td rowspan="<c:out value="${groupInfo.orderCount}" />">
												<c:out value="${groupInfo.drawPNR}"></c:out>
											</td>
											<td rowspan="<c:out value="${groupInfo.orderCount}" />">
												<c:out value="${groupInfo.ticketPrice}"></c:out>
											</td>
											<td rowspan="<c:out value="${groupInfo.orderCount}" />">
												<c:out value="${groupInfo.airportPrice}"></c:out>
											</td>
											<td rowspan="<c:out value="${groupInfo.orderCount}" />">
												<c:out value="${groupInfo.fuelPrice}"></c:out>
											</td>
											<td><c:out value="${groupInfo.orderList[0].platform.showName}" /></td>
										    <td><c:out value="${groupInfo.orderList[0].totalAmount}" /></td>										   	
										</tr>								
