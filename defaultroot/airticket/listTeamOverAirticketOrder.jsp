...
<html>
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="/airticket/listAirTicketOrder.do?thisAction=listTeamOverAirticketOrder">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../_jsp/mainTitle.jsp?title1=票务管理&title2=完全出票订单"
									charEncoding="UTF-8" />
                        		...
                        		<c:forEach var="info" items="${ulf.list}" varStatus="status">
									<tr>
                                      ...
                                      <c:forEach var="flight3" items="${info.flights}">
										...
										<td>
										<a style="display: none;" href="<%=path %>/airticket/listAirTicketOrder.do?thisAction=updaTempAirticketOrderPage&airticketOrderId=<c:out value="${info.id}" />">编辑</a><br />
										<a style="display: none;" href="<%=path %>/airticket/listAirTicketOrder.do?thisAction=updateAirticketOrderByStatus&airticketOrderId=<c:out value="${info.id}" />">删除</a><br />
										</td>
									</tr>
                                 </c:forEach>
								</table>
