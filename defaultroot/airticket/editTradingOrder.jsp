				...
				航班信息：  
							...
							<table cellpadding="0" cellspacing="0" border="0" id="flightTable"
							      ...
							      <tr>	
								        ...
								        <td><input type="text" name="boardingTimes" value="<c:out value='${flight.boardingTime}'/>" class="colorblue2 p_5"	style="width:120px;"/></td>
						...
						<c:forEach var="airticketOrder" items="${airticketOrderList.list}" varStatus="status">
								...
								<table cellpadding="0" cellspacing="0" border="0" id="table1" class="dataList">
									<tr>
									    <td>类别	
									     ...
									     <td><div>出票PNR 	<html:text property="drawPnr"  name="airticketOrder" value="${airticketOrder.drawPnr}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>
									     <td><div>预定PNR	<html:text property="subPnr" name="airticketOrder" value="${airticketOrder.drawPnr}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>		
										<td><div>大PNR	<html:text property="bigPnr" name="airticketOrder" value="${airticketOrder.bigPnr}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>	
									     <td><div>票面价	<html:text property="ticketPrice" name="airticketOrder" value="${airticketOrder.ticketPrice}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>
									     <td><div>机建税	<html:text property="airportPrice" name="airticketOrder" value="${airticketOrder.airportPrice}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>
									     <td><div>燃油税	<html:text property="fuelPrice" name="airticketOrder" value="${airticketOrder.fuelPrice}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>
									     <td><div>手续费	<html:text property="handlingCharge" name="airticketOrder"  value="${airticketOrder.handlingCharge}"  styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>
									     <td><div>政策	<html:text property="rebate" name="airticketOrder"  value="${airticketOrder.rebate}" styleClass="colorblue2 p_5"	style="width:50px;" /> </div></td>
									</tr>
									<tr>
								   ...
								   <td> 机票类型<select name="ticketType" id="ticketType" class="text ui-widget-content ui-corner-all">		
									   ...
									   <select name="platformId"  id="platformId<c:out value='${status.count}'/>" onclick="checkPlatform('platformId<c:out value='${status.count}'/>','companyId<c:out value='${status.count}'/>','accountId<c:out value='${status.count}'/>')">		
																										
									   </select>
										</div></td>
										<td>公司	
										<input type="hidden" name="tmpCompanyId" value="<c:out value="${airticketOrder.statement.platComAccount.company.id}"/>"/>	
										<select name="companyId" id="companyId<c:out value='${status.count}'/>" onclick="checkCompany('platformId<c:out value='${status.count}'/>','companyId<c:out value='${status.count}'/>','accountId<c:out value='${status.count}'/>')" >		
									...
									<select id="ktype<c:out value='${status.count}'/>" name="status">
							...
							<td>
							    ...
							    <html:select property="statement.status" name="airticketOrder">
							       <html:option value="0">未结算</html:option>
							       <html:option value="1">已结算</html:option>
							       <html:option value="2">部分结算</html:option>
							    </html:select>
							    </td>
						        <td> 帐号
