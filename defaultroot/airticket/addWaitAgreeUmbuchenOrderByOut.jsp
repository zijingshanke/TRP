					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../_jsp/mainTitle.jsp?title1=票务管理&title2=改签订单录入(外部)"
									charEncoding="UTF-8" />
	...
	<form action="../airticket/airticketOrder.do?thisAction=airticketOrderByBlackOutPNR"  method="post" id="form3" >
		...
		<script type="text/javascript">
		      ...
		      /*   if(bigPnr==""){
		         ...
		         document.forms[0].action="airticketOrder.do?thisAction=addWaitAgreeUmbuchenOrder";
                 document.forms[0].submit();
		      ...
		      function addOutPnr(){
		         ...
		         document.forms[0].action="airticketOrder.do?thisAction=addOutWaitAgreeUmbuchenOrder";
                 document.forms[0].submit();
